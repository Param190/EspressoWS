					...
					<div class="section_contact__info">
						<div class="section_contact__info__item">
							...
							<p class="section_contact__info__item__content">
								<a href="mailto:infothecafeteria@gmail.com">contact@gmail.com</a>
							</p>
						</div>
						<div class="section_contact__info__item">
							<h4 class="section_contact__info__item__heading">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<ul class="section_footer__info">
						...
						<li>
							<i class="far fa-envelope"></i> <a href="mailto:infothecafeteria@gmail.com">contact@gmail.com</a>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-12">
					...
					<div class="section_footer__copyright">
						&copy; <span id="js-current-year"></span>Espresso Express.
					</div>
